...
sub write_css {
    ...
    #TODO: properly
    open my $fh, '>', $self->_base_dir . "/default.min.css"
        or die $!;
...
EOF
    ...
    #TODO: properly
    open $fh, '>', $self->_base_dir . "/style.css"
        or die $!;
...
sub write_js {
    my $self = shift;
        ...
        #TODO: properly
    open my $fh, '>', $self->_base_dir . "/highlight.min.js"
        or die $!;
...
sub write_pod {
    ...
    print $fh $self->munge_html($depth - 1, $pod, $name);
}
